...
results_log_plot = function(tab,metadata,PASS=TRUE){
  ...
  #J7 et J14 ensemble
  p1=ggplot(tab_lm_AB) +
    aes(x=Materiel, y=log_rapport,color=Materiel) +
    ...
    theme(plot.title = element_text(hjust = 0.5), axis.title.y = element_text(size = 8)) #couleur des points en fonction de l'inoculum mais meme boxplot
  ...
  p2=ggplot(tab_lm_EF) +
    ...
    ylim(-8, 2.7) +
    ylab("Abondance relative \n log(gène/ARNr16S)") +
    geom_dotplot(aes(fill=Campagne), binaxis='y', stackdir='center',size=1, position=position_dodge(0)) +
  ...
  p3=ggplot(tab_lm_EF) +
    aes(x=Campagne, y=log_rapport,color=Campagne) +
    geom_boxplot(outlier.colour="black", outlier.shape=NA,outlier.size=2, notch=FALSE) +
...
ggplot(tab_lm_EF) +
  aes(x=ATB_type, y=log_rapport,color=ATB_type) +
    ...
    ylim(-8, 2.7) +
    ylab("Abondance relative \n log(gène/réf)") +
    geom_dotplot(aes(fill=Campagne,color=Tm_QC), binaxis='y', stackdir='center',size=1, position=position_dodge(0)) +
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrA_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrA_plot_ATB_EF.png",sep=""),width=7,height = 4, units='in',res=600)
results_log_plot(PCR_19_qnrA_tri,metadata)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrA_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrB_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_20_qnrB_tri,metadata)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrB_plot_ATB_EF.png",sep=""),width=7,height = 4, units='in',res=600)
results_log_plot(PCR_20_qnrB_tri,metadata)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrB_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrS_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata,PASS=FALSE)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrS_plot_ATB_EF.png",sep=""),width=7,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata,PASS=FALSE)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrS_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrD_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata,PASS=FALSE)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrD_plot_ATB_EF.png",sep=""),width=7,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata,PASS=FALSE)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrD_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
