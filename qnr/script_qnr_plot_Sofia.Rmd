...
metadata$type_ech = factor(metadata$type_ech, levels=c('Ech in situ','BF in vitro')) #on réordonne les type d'échantillon pour l'affichage sur les graphiques
...
results_log_plot = function(tab,metadata,PASS=TRUE){
  ...
  p1=ggplot(tab_lm_AB) +
    ...
    theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5)) #couleur des points en fonction de l'inoculum mais meme boxplot
  ...
  p3=ggplot(tab_lm_EF) +
    aes(x=campaign, y=log_rapport,color=campaign) +
    geom_boxplot(outlier.colour="black", outlier.shape=NA,outlier.size=2, notch=FALSE) +
...
metadata$type_ech = factor(metadata$type_ech, levels=c('Ech in situ','BF in vitro'))
...
# png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/qnrA_plot_AB.png",sep=""),width=8,height = 4, units='in',res=600)
...
png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrA_plot_ATB_EF.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_19_qnrA_tri,metadata)[2]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/qnrA_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrB_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_20_qnrB_tri,metadata)[1]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/qnrB_plot_ATB_EF.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_20_qnrB_tri,metadata)[2]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrB_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrS_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata,PASS=FALSE)[1]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrS_plot_ATB_EF.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata,PASS=FALSE)[2]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/qnrS_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrD_plot_AB.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata,PASS=FALSE)[1]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/qnrD_plot_ATB_EF.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata,PASS=FALSE)[2]
dev.off()

png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/qnrD_plot_Dosage_EF.png",sep=""),width=6,height = 4, units='in',res=600)
