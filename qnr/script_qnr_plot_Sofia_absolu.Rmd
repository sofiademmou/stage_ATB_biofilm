...
results_log_plot = function(tab,metadata){
  for (i in 1:20){
  ...
  #J7 et J14 ensemble
  p1=ggplot(tab_lm_AB) +
    aes(x=Materiel, y=log_absolu,color=Materiel) +
    geom_boxplot(outlier.colour="black", outlier.shape=NA,outlier.size=2, notch=FALSE) +
    scale_color_manual(values=c("black","#999999","#f1c40f"))+
    ylim(-1, 10) +
    ...
    scale_fill_manual(values=c("#F29A18", "#00A878","#5AB1BB","#81654B")) + #0471A6 (bleu)  #67513C (marron)
    ...
    theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5), axis.title.y = element_text(size = 8))  #) #couleur des points en fonction de l'inoculum mais meme boxplot
  
  print(p1)

  
  tab_lm_EF$Campagne = factor(tab_lm_EF$Campagne,levels = c("envt","F (2.5 µg/L)","E (5 mg/L)"))
  tab_lm_EF$ATB_type = factor(tab_lm_EF$ATB_type,levels = c("Témoin","FQ1","FQ2","FQ1+FQ2"))
  ...
  p2=ggplot(tab_lm_EF) +
    ...
    ylim(-1, 10) +
    ylab("Nombre de copies de gènes/unité de quantité") +
    geom_dotplot(aes(fill=Campagne,color="black"), binaxis='y', stackdir='center',size=1, position=position_dodge(0)) +
    ...
    theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5), axis.title.y = element_text(size = 8))
  

  
  p3=ggplot(tab_lm_EF) +
    aes(x=Campagne, y=log_absolu,color=Campagne) +
    geom_boxplot(outlier.colour="black", outlier.shape=NA,outlier.size=2, notch=FALSE) +
    scale_color_manual(values=c("#CAD5D8","#2c3e50", "#999999", "black"))  +
    ylim(-1, 10) +
    ylab("Nombre de copies de gènes/unité de quantité") +
    geom_dotplot(aes(fill=ATB_type,color="black"), binaxis='y', stackdir='center',size=1, position=position_dodge(0)) +
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/16S_plot_AB_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_18_16S_tri,metadata)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/16S_plot_ATB_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_18_16S_tri,metadata)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/16S_plot_Dosage_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_18_16S_tri,metadata)[3]
dev.off()
```
</br>
</br>
...
# png(paste("C:/Users/sdemmou/OneDrive/stage/ENVT/qPCR/figures_qnr/qnrA_plot_AB.png",sep=""),width=8,height = 4, units='in',res=600)
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrA_plot_AB_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_19_qnrA_tri,metadata)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrA_plot_ATB_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_19_qnrA_tri,metadata)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrA_plot_Dosage_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrB_plot_AB_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_20_qnrB_tri,metadata)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrB_plot_ATB_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_20_qnrB_tri,metadata)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrB_plot_Dosage_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrS_plot_AB_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrS_plot_ATB_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata)[2]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrS_plot_Dosage_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_21_qnrS_tri,metadata)[3]
dev.off()
```
</br>
</br>
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrD_plot_AB_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata)[1]
dev.off()

png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/FR/absolu/qnrD_plot_ATB_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata)[2]
dev.off()
...
png(paste("C:/Users/Marie Claire Demmou/OneDrive/stage/ENVT/qPCR/figures_qnr/figures_finales/absolu/qnrD_plot_Dosage_EF_absolu.png",sep=""),width=6,height = 4, units='in',res=600)
results_log_plot(PCR_22_qnrD_tri,metadata)[3]
dev.off()
```
