...
dico_co_occ={"S83" : 0, "D87" : 0, "co_occurence" : 0}
...
def mutations_gyrA(ref,ech,ech_out):
    ...
    #my_dict["S83L seul"]=my_dict["S83"]-my_dict["co_occurence"]
    my_dict["S83 + D87"]=my_dict["co_occurence"]/my_dict["S83"]*100
    my_dict["D87 + S83"]=my_dict["co_occurence"]/my_dict["D87"]*100
    print(my_dict)
    print(reads)
