...
La détection de variants au niveau des gènes *gyrA* et *parC* nécessite l'utilisation d'un cluster. Pour cela, il suffit de lancer MobaXterm, puis de se connecter aux serveurs GenoToul en créant une nouvelle session en ssh, puis en rentrant l'hôte genologin.toulouse.inra.fr (remote host) et son identifiant GenoToul.  
